...
const T3_MCP_TOOL_DISPLAY_NAMES: Record<string, string> = {
  ...
  t3_terminal_list: "List managed terminals",
  t3_terminal_read: "Read managed terminal output",
  t3_terminal_open: "Open a managed terminal",
  t3_terminal_write: "Write to a managed terminal",
  t3_terminal_resize: "Resize a managed terminal",
  t3_terminal_clear: "Clear managed terminal output",
  t3_terminal_restart: "Restart a managed terminal",
  t3_terminal_close: "Close a managed terminal",
  t3_project_script_list: "List saved project scripts",
  t3_project_script_run: "Run a saved project script",
  t3_project_script_stop: "Stop a saved project script",
