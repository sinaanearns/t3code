...
const T3_MCP_TOOL_DISPLAY_NAMES: Record<string, string> = {
  ...
  t3_project_list: "List T3 projects",
  t3_project_read: "Read a T3 project",
  t3_project_create: "Create a T3 project",
  t3_project_update: "Update a T3 project",
  t3_project_delete: "Delete a T3 project",
