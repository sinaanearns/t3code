...
const T3_MCP_TOOL_DISPLAY_NAMES: Record<string, string> = {
  ...
  t3_queue_list: "List queued T3 work",
  t3_queue_read: "Read queued T3 work",
  t3_queue_edit: "Edit queued T3 work",
  t3_queue_reorder: "Reorder queued T3 work",
  t3_queue_cancel: "Cancel queued T3 work",
  t3_queue_promote_to_steer: "Promote queued T3 work to steer",
