...
const T3_MCP_TOOL_DISPLAY_NAMES: Record<string, string> = {
  ...
  t3_pending_request_list: "List delegated user-input requests",
  t3_pending_request_read: "Read a delegated user-input request",
  t3_pending_request_respond: "Answer a delegated user-input request",
