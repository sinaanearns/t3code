...
function getGnomeKeyringRemediationMessage(): string {
  return "Rearvy Coding Agent could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart Rearvy Coding Agent.";
}

function getKWalletRemediationMessage(): string {
  return "Rearvy Coding Agent could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart Rearvy Coding Agent.";
}
