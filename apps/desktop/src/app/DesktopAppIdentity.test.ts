...
const makeElectronAppLayer = (calls: ElectronAppCalls) =>
  Layer.succeed(ElectronApp.ElectronApp, {
    ...
    name: Effect.succeed("Rearvy Coding Agent"),
  ...
  it.effect("configures app identity from the environment commit override", () => {
    ...
    return withIdentity(
      Effect.gen(function* () {
        ...
        assert.deepEqual(calls.setName, ["Rearvy Coding Agent (Alpha)"]);
        assert.equal(calls.setAboutPanelOptions[0]?.applicationName, "Rearvy Coding Agent (Alpha)");
