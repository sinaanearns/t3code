// This file mostly exists because we want dev mode to say "Rearvy Coding Agent (Dev)" instead of "electron"
...
export const APP_DISPLAY_NAME = isDevelopment
  ? "Rearvy Coding Agent (Dev)"
  : "Rearvy Coding Agent (Alpha)";
...
function buildMacLauncher(electronBinaryPath) {
  ...
  if (isDevelopment) {
    ...
    // Electron.app even though this bundle's Info.plist has the Rearvy name.
