...
/**
 * Rearvy's trefoil mark. The brand ships only a raster logo, so this is a
 * monochrome vector of it: the body in `currentColor` with the tilted "eye"
 * and the lower-left dot knocked out via `evenodd`, which keeps it legible on
 * both themes at rail size without needing two colour variants.
 */
export const RearvyIcon: Icon = ({ className, ...props }) => (
  <svg
    {...props}
