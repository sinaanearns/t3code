...
/**
 * The palette Rearvy Coding Agent wears with no theme installed, captured from the app's
...
/**
 * The standard Rearvy Coding Agent look as a theme palette, for seeding a new theme when
...
/**
 * The status colors Rearvy Coding Agent shows without a theme, read from the app's own
