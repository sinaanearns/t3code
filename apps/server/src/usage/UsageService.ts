 ...
 * Grok Build) rather than Rearvy Coding Agent's orchestration projections, so usage covers
 * turns driven outside Rearvy Coding Agent too. This is the approach `ccusage` takes.
 *
