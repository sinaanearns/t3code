            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but Rearvy Coding Agent could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but Rearvy Coding Agent still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
